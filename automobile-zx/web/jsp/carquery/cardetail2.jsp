                        ...
                        <div class="form-group">
                            <div style="position: relative;">
                                <input id="city-picker3" class="form-control" readonly type="text" value="江苏省/常州市/溧阳市"
                                       data-toggle="city-picker" name="citys">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="fengye">
                ...
                <%--<a href="javascript:void(0)" onclick="syy()" style="display: none" id="prev">上一页</a>&nbsp;--%>
                <c:if test="${page.currentPage < page.totalPage}">
                    <a href="javascript:void(0)" onclick="xyy()">下一页</a>&nbsp;
                </c:if>
                <a href="javascript:void(0)" onclick="my()">末页</a>&nbsp;
...
<script type="text/javascript">
    ...
    function sy() {
        $.post("${pageContext.request.contextPath}/CarServlet",
            {"currentPage":${page.firstPage}, "method": "getCars", "opr": "asyc"},
            function (data) {
                alert(data);
                var count = "";
                $(data.data).each(function (index, item) {
                    count += "<div class=\"col-md-3 col-sm-6 col-xs-12 gezi\"><img src=\"" + item.image + "\" alt=\"\"><div class=\"text\"><span class=\"tit\">" + item.header + "</span><%--加入的字不要超过11个--%>\n" +
                        "<br/>自动/5座</div></div>";
                    $("#chaxun").html(count);
                })
            }, 'json');
    ...
    function syy() {
        $.post("${pageContext.request.contextPath}/CarServlet",
            {"currentPage":${page.prePage}, "method": "getCars"},
            function (data) {
                var count = "";
                $(data.data).each(function (index, item) {
                    count += "<div class=\"col-md-3 col-sm-6 col-xs-12 gezi\"><img src=\"" + item.image + "\" alt=\"\"><div class=\"text\"><span class=\"tit\">" + item.header + "</span><%--加入的字不要超过11个--%>\n" +
    ...
    function xyy() {
        $.post("${pageContext.request.contextPath}/CarServlet",
            {"currentPage":${page.nextPage}, "method": "getCars"},
            function (data) {
                var count = "";
                $(data.data).each(function (index, item) {
                    count += "<div class=\"col-md-3 col-sm-6 col-xs-12 gezi\"><img src=\"" + item.image + "\" alt=\"\"><div class=\"text\"><span class=\"tit\">" + item.header + "</span><%--加入的字不要超过11个--%>\n" +
    ...
    function my() {
        $.post("${pageContext.request.contextPath}/CarServlet",
            {"currentPage":${page.totalPage}, "method": "getCars"},
            function (data) {
                var count = "";
                $(data.data).each(function (index, item) {
                    count += "<div class=\"col-md-3 col-sm-6 col-xs-12 gezi\"><img src=\"" + item.image + "\" alt=\"\"><div class=\"text\"><span class=\"tit\">" + item.header + "</span><%--加入的字不要超过11个--%>\n" +
