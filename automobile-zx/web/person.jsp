...
<head>
    ...
    <style>
        ...
        .order-list-null {
            ...
            background: url("/images/bg_order_null.png ") no-repeat 0 center;
                ...
                <div class="logo " style="width:100%;">
                    ...
                    <div>
                        <ul class="listul" style="margin-left: 10%;">
                          <li data-toggle="modal"  data-target=".bs-example-modal-lg1">
                                <img src="/images/1.png" alt="">
                                <p>随时预订下单</p>
                            </li>
                            <li data-toggle="modal" data-target=".bs-example-modal-lg2">
                                <img src="/images/2.png" alt="">
                                <p>生日优惠</p>
                            </li>
                            <li data-toggle="modal"  data-target=".bs-example-modal-lg3">
                            <img src="../images/3.png" alt="">
                                <p>会员积分</p>
                            </li>
                            <li data-toggle="modal"  data-target=" .bs-example-modal-lg4">
                                <img src="/images/4.png" alt="">
                                <p>免验车服务</p>
                            </li>
                            <li data-toggle="modal"  data-target=" .bs-example-modal-lg5">
                            <img src="../images/5.png" alt="">
                                <p>异地还车优惠</p>
                            </li>
                            <li data-toggle="modal" data-target=" .bs-example-modal-lg6">
                                <img src="/images/6.png" alt="">
                                <p>周中用车优惠</p>
                            </li>
                            <li data-toggle="modal" data-target=".bs-example-modal-lg7">
                                <img src="/images/7.png" alt="">
                                <p>新车到店通知</p>
                            </li>
                            <li data-toggle="modal" data-target=".bs-example-modal-lg8" >
                                <img src="/images/8.png" alt="">
                                <p>延时还车</p>
                            </li>
                            <li data-toggle="modal" data-target=".bs-example-modal-lg9">
